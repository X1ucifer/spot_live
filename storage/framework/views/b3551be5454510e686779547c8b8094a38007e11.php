...
} elseif ($_instance->childHasBeenRendered('TZ5WiIN')) {
    $componentId = $_instance->getRenderedChildComponentId('TZ5WiIN');
    $componentTag = $_instance->getRenderedChildComponentTagName('TZ5WiIN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TZ5WiIN');
} else {
    $response = \Livewire\Livewire::mount('component.dynamic-nav-menu', []);
    $html = $response->html();
    $_instance->logRenderedChild('TZ5WiIN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH F:\Freelancing\spot_live\resources\views/layouts/partials/nav/menu.blade.php ENDPATH**/ ?>