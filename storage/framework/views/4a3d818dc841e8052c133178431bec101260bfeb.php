...
<link href="<?php echo e(asset('css/quill.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
} elseif ($_instance->childHasBeenRendered('RFlN94i')) {
    $componentId = $_instance->getRenderedChildComponentId('RFlN94i');
    $componentTag = $_instance->getRenderedChildComponentTagName('RFlN94i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RFlN94i');
} else {
    $response = \Livewire\Livewire::mount('tables.product-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('RFlN94i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','max' => ''.e(setting('filelimit.max_product_images', 3)).'','maxSize' => ''.e(setting('filelimit.product_image_size', 200)).''])->html();
} elseif ($_instance->childHasBeenRendered('LXnFGDr')) {
    $componentId = $_instance->getRenderedChildComponentId('LXnFGDr');
    $componentTag = $_instance->getRenderedChildComponentTagName('LXnFGDr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LXnFGDr');
} else {
    $response = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','max' => ''.e(setting('filelimit.max_product_images', 3)).'','maxSize' => ''.e(setting('filelimit.product_image_size', 200)).'']);
    $html = $response->html();
    $_instance->logRenderedChild('LXnFGDr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('arm7NtN')) {
    $componentId = $_instance->getRenderedChildComponentId('arm7NtN');
    $componentTag = $_instance->getRenderedChildComponentTagName('arm7NtN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('arm7NtN');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('arm7NtN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('A6ycHod')) {
    $componentId = $_instance->getRenderedChildComponentId('A6ycHod');
    $componentTag = $_instance->getRenderedChildComponentTagName('A6ycHod');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('A6ycHod');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('A6ycHod', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','preview' => $photos,'max' => ''.e(setting('filelimit.max_product_images', 3)).'','maxSize' => ''.e(setting('filelimit.product_image_size', 200)).''])->html();
} elseif ($_instance->childHasBeenRendered('4pcQKYU')) {
    $componentId = $_instance->getRenderedChildComponentId('4pcQKYU');
    $componentTag = $_instance->getRenderedChildComponentTagName('4pcQKYU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4pcQKYU');
} else {
    $response = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','preview' => $photos,'max' => ''.e(setting('filelimit.max_product_images', 3)).'','maxSize' => ''.e(setting('filelimit.product_image_size', 200)).'']);
    $html = $response->html();
    $_instance->logRenderedChild('4pcQKYU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').''])->html();
} elseif ($_instance->childHasBeenRendered('4LJJ4SV')) {
    $componentId = $_instance->getRenderedChildComponentId('4LJJ4SV');
    $componentTag = $_instance->getRenderedChildComponentTagName('4LJJ4SV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4LJJ4SV');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').'']);
    $html = $response->html();
    $_instance->logRenderedChild('4LJJ4SV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent'])->html();
} elseif ($_instance->childHasBeenRendered('HAWYC15')) {
    $componentId = $_instance->getRenderedChildComponentId('HAWYC15');
    $componentTag = $_instance->getRenderedChildComponentTagName('HAWYC15');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HAWYC15');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent']);
    $html = $response->html();
    $_instance->logRenderedChild('HAWYC15', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Add')).'','action' => 'assignSubcategories']); ?>
        ...
        <p class="text-sm text-gray-500"><?php echo e(__('Note: Only sub-categories of the assigned product categories will be listed here')); ?></>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Add')).'','action' => 'assignMenus']); ?>
        ...
        <p class="text-sm text-gray-500"><?php echo e(__('Note: Menus of selected vendor for product will be listed here')); ?></>
...
<?php $component->withAttributes(['title' => ''.e(__('Photos')).'','text' => '']); ?>
            <div class="flex flex-wrap space-x-3 space-y-3">
                ...
                <a href="<?php echo e($photo); ?>" target="_blank"><img src="<?php echo e($photo); ?>" class="w-24 h-24 mx-2 rounded-sm" /></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
         <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/products.blade.php ENDPATH**/ ?>