...
} elseif ($_instance->childHasBeenRendered('n325hy1')) {
    $componentId = $_instance->getRenderedChildComponentId('n325hy1');
    $componentTag = $_instance->getRenderedChildComponentTagName('n325hy1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n325hy1');
} else {
    $response = \Livewire\Livewire::mount('tables.category-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('n325hy1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/categories.blade.php ENDPATH**/ ?>