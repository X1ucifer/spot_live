...
} elseif ($_instance->childHasBeenRendered('o9iffl7')) {
    $componentId = $_instance->getRenderedChildComponentId('o9iffl7');
    $componentTag = $_instance->getRenderedChildComponentTagName('o9iffl7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('o9iffl7');
} else {
    $response = \Livewire\Livewire::mount('tables.order-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('o9iffl7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('sT0zLQ6')) {
    $componentId = $_instance->getRenderedChildComponentId('sT0zLQ6');
    $componentTag = $_instance->getRenderedChildComponentTagName('sT0zLQ6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sT0zLQ6');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('sT0zLQ6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('sG23sjr')) {
    $componentId = $_instance->getRenderedChildComponentId('sG23sjr');
    $componentTag = $_instance->getRenderedChildComponentTagName('sG23sjr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sG23sjr');
} else {
    $response = \Livewire\Livewire::mount('edit-order-livewire');
    $html = $response->html();
    $_instance->logRenderedChild('sG23sjr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Next')).'','action' => 'showOrderSummary','clickAway' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','queryClause' => $vendorSearchClause,'emitFunction' => 'autocompleteVendorSelected','onclearCalled' => 'clearAutocompleteFieldsEvent','customQuery' => 'vendor_data'])->html();
} elseif ($_instance->childHasBeenRendered('v63X63z')) {
    $componentId = $_instance->getRenderedChildComponentId('v63X63z');
    $componentTag = $_instance->getRenderedChildComponentTagName('v63X63z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('v63X63z');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','queryClause' => $vendorSearchClause,'emitFunction' => 'autocompleteVendorSelected','onclearCalled' => 'clearAutocompleteFieldsEvent','customQuery' => 'vendor_data']);
    $html = $response->html();
    $_instance->logRenderedChild('v63X63z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Product')).'','column' => 'name','model' => 'Product','emitFunction' => 'autocompleteProductSelected','updateQueryClauseName' => 'productQueryClasueUpdate','clear' => true,'queryClause' => $productSearchClause,'onclearCalled' => 'clearAutocompleteFieldsEvent','customQuery' => 'product_data'])->html();
} elseif ($_instance->childHasBeenRendered('cwUqHe8')) {
    $componentId = $_instance->getRenderedChildComponentId('cwUqHe8');
    $componentTag = $_instance->getRenderedChildComponentTagName('cwUqHe8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cwUqHe8');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Product')).'','column' => 'name','model' => 'Product','emitFunction' => 'autocompleteProductSelected','updateQueryClauseName' => 'productQueryClasueUpdate','clear' => true,'queryClause' => $productSearchClause,'onclearCalled' => 'clearAutocompleteFieldsEvent','customQuery' => 'product_data']);
    $html = $response->html();
    $_instance->logRenderedChild('cwUqHe8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('TV6G7b7')) {
    $componentId = $_instance->getRenderedChildComponentId('TV6G7b7');
    $componentTag = $_instance->getRenderedChildComponentTagName('TV6G7b7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TV6G7b7');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('TV6G7b7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('sktlSis')) {
    $componentId = $_instance->getRenderedChildComponentId('sktlSis');
    $componentTag = $_instance->getRenderedChildComponentTagName('sktlSis');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sktlSis');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('sktlSis', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/orders.blade.php ENDPATH**/ ?>