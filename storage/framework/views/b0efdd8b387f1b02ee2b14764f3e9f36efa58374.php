...
} elseif ($_instance->childHasBeenRendered('wDozSqX')) {
    $componentId = $_instance->getRenderedChildComponentId('wDozSqX');
    $componentTag = $_instance->getRenderedChildComponentTagName('wDozSqX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wDozSqX');
} else {
    $response = \Livewire\Livewire::mount('tables.user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('wDozSqX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/users.blade.php ENDPATH**/ ?>