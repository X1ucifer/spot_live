...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.baseview','data' => ['title' => ''.e(__('Menu')).'','showNew' => \Auth::user()->hasAnyRole('manager'),'newInfo' => true]]); ?>
<?php $component->withName('baseview'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => ''.e(__('Menu')).'','showNew' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Auth::user()->hasAnyRole('manager')),'newInfo' => true]); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('tables.menu-table', [])->html();
} elseif ($_instance->childHasBeenRendered('WlmZR8Y')) {
    $componentId = $_instance->getRenderedChildComponentId('WlmZR8Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('WlmZR8Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WlmZR8Y');
} else {
    $response = \Livewire\Livewire::mount('tables.menu-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('WlmZR8Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Save')).'','action' => 'save']); ?>
            <p class="text-xl font-semibold"><?php echo e(__('Create Menu')); ?></p>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Update')).'','action' => 'update']); ?>
            <p class="text-xl font-semibold"><?php echo e(__('Update Menu')); ?></p>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/menu.blade.php ENDPATH**/ ?>