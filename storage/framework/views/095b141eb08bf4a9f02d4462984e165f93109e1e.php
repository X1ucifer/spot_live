...
} elseif ($_instance->childHasBeenRendered('CMGTJVi')) {
    $componentId = $_instance->getRenderedChildComponentId('CMGTJVi');
    $componentTag = $_instance->getRenderedChildComponentTagName('CMGTJVi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CMGTJVi');
} else {
    $response = \Livewire\Livewire::mount('tables.push-notification-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('CMGTJVi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('MNkiXBv')) {
    $componentId = $_instance->getRenderedChildComponentId('MNkiXBv');
    $componentTag = $_instance->getRenderedChildComponentTagName('MNkiXBv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MNkiXBv');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('MNkiXBv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('rNR6YjE')) {
    $componentId = $_instance->getRenderedChildComponentId('rNR6YjE');
    $componentTag = $_instance->getRenderedChildComponentTagName('rNR6YjE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rNR6YjE');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('rNR6YjE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('o68vEoZ')) {
    $componentId = $_instance->getRenderedChildComponentId('o68vEoZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('o68vEoZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('o68vEoZ');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('o68vEoZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/livewire/notification.blade.php ENDPATH**/ ?>