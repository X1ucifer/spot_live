    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="flex items-center space-x-4 text-lg font-bold text-gray-100 ltr:ml-6 rtl:mr-6" href="<?php echo e(route('dashboard')); ?>">
            ...
            <div class="ltr:pl-6 rtl:pr-6">
                ...
                <?php if(auth()->check() && auth()->user()->hasAnyRole('aaaaaa')): ?>
...
<?php /**PATH /home/spotd2d/domains/client.spotd2d.com/public_html/resources/views/layouts/partials/nav/desktop.blade.php ENDPATH**/ ?>