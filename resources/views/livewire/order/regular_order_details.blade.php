...
<div class="pt-4 border-t justify-items-end">
    ...
    <div class="flex items-center justify-end space-x-20 border-b">
        <x-label title="{{ __('Total Product Price') }}" />
    ...
    <div class="flex items-center justify-end space-x-20 border-b">
        ...
        <div class="w-6/12 md:w-4/12 lg:w-2/12">
        <x-details.p text="+{{ currencyFormat($selectedModel->tip ?? '') }}" />
        </div>
    </div>
    ...
    <div class="flex items-center justify-end space-x-20 border-b">
        ...
        <div class="w-6/12 md:w-4/12 lg:w-2/12">
            <x-details.p text="{{ currencyFormat($selectedModel->sub_total + $selectedModel->tax +  $selectedModel->delivery_fee + $selectedModel->tip ?? '') }}" />
    ...
    <div class="flex items-center justify-end space-x-20 border-b">
        <x-label title="{{ __('Wallet Amount') }}" />
        <div class="w-6/12 md:w-4/12 lg:w-2/12">
            <x-details.p text="-{{ currencyFormat($selectedModel->wallet_amount ?? '') }}" />
        </div>
    </div>
