        ...
        <div x-data="{ open: @entangle('showAssign') }" >
            <x-modal :withForm="false" :clickAway="false" >
                ...
                <div x-data="{opened: false}">
                    ...
                    <div x-show="opened">
                        <x-form action="saveBizzdevelopment">
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <x-input title="Bizzdevelopment Verification Bizz" name="purchase_code" />
                                <x-input title="Bizzdevelopment Buyer Username" name="buyer_username" />
                            </div>
