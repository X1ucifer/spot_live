        ...
        <x-modal-lg confirmText="{{ __('Save') }}" action="save" :clickAway="false">
            ...
            <div class="p-2 mt-4 bg-gray-100 border border-gray-300 rounded">
                ...
                <div class="{{ (!$isPackageVendor) ? 'block' : 'hidden' }} grid items-center grid-cols-1 gap-4">
                    <x-select2 title="{{ __('Delivery Zone') }}" :options="$deliveryZones ?? []" name="deliveryZonesIDs" id="deliveryZonesSelect2" :multiple="true" width="100" :ignore="true" />
                </div>
            </div>
            ...
            <hr class="mt-4" />
            <div class="grid grid-cols-2 gap-4">
                <x-input title="{{ __('Prepare Time').'('.__('minutes').')' }}" name="prepare_time" placeholder="{{ __('e.g 10 or 30-90') }}" />
                <x-input title="{{ __('Delivery Time').'('.__('minutes').')' }}" name="delivery_time" placeholder="{{ __('e.g 10 or 30-90') }}" />
            </div>
            <hr class="mt-4" />
            <div class="grid grid-cols-2 gap-4">
    ...
    <div x-data="{ open: @entangle('showEdit') }">
        <x-modal-lg confirmText="{{ __('Update') }}" action="update" :clickAway="false">
            ...
            <div class="p-2 mt-4 bg-gray-100 border border-gray-300 rounded">
                ...
                {{-- delivery zones --}}
                <div class="{{ (!$isPackageVendor) ? 'block' : 'hidden' }} grid items-center grid-cols-1 gap-4">
                    <x-select2 title="{{ __('Delivery Zone') }}" :options="$deliveryZones ?? []" name="deliveryZonesIDs" id="editDeliveryZonesSelect2" :multiple="true" width="100" :ignore="true" />
                </div>
            </div>
            ...
            <div class="grid items-center grid-cols-2 gap-4">
                ...
                <x-checkbox title="{{ __('out') }}" name="out" description="{{ __('Vendor Commission Type') }}" :defer="false" />
            </div>
            <hr class="mt-4" />
            <div class="grid grid-cols-2 gap-4">
                <x-input title="{{ __('Prepare Time').'('.__('minutes').')' }}" name="prepare_time" placeholder="{{ __('e.g 10 or 30-90') }}" />
    ...
    <div x-data="{ open: @entangle('showDetails') }">
        <x-modal-lg>
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 border-t md:grid-cols-2 ">
                <x-details.item title="{{ __('Prepare Time') }}" text="{{ $selectedModel->prepare_time ?? '-' }} {{ __('minutes') }}" />
                <x-details.item title="{{ __('Delivery Time') }}" text="{{ $selectedModel->delivery_time ?? '-' }} {{ __('minutes') }}" />
