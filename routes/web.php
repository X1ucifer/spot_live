...
use App\Http\Livewire\AdsServicesLivewire;
...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('clearcache', 'App\Http\Livewire\Auth\RegisterLivewire@clearcache')->name('clearcache');
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        // Route::middleware(['checkRole:sub-admin'])->group(function(){
        ...
        Route::group(['middleware' => ['role:admin|sub-admin']], function () {
            ...
            Route::get('banners', BannerLivewire::class)->name('banners');
            Route::get('ads', AdsServicesLivewire::class)->name('adsservices');
            Route::get('/progress/{link}', 'App\Http\Livewire\AdsServicesLivewire@index')
            ->name('track.progress');
