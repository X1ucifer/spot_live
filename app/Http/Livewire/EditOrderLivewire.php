...
class EditOrderLivewire extends BaseLivewireComponent
{
    ...
    public function showEditProducts($selectedModel)
    {
        $this->selectedModel = $selectedModel;
        $this->productSearchClause = ['vendor_id' => $selectedModel["vendor_id"]];
    ...
    public function updateOrderProducts()
    {
        ...
        try {
			...
			$this->selectedModel->tax=number_format($subtotal * ($this->selectedModel->vendor->tax / 100), 2, '.', '');
