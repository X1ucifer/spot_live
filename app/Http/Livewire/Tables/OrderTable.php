...
class OrderTable extends BaseDataTableComponent
{
    ...
    public function query()
    {
        ...
        if ($user->hasRole('admin')) {
            ...
            $query = Order::setEagerLoads([]);
        }else if($user->hasRole('sub-admin')){
            $query = Order::setEagerLoads([]);
        }
         else {
    ...
    public function columns(): array
    {
        ...
        $columns = [
          ...
          Column::make(__('Vendor'), 'vendor.name'),
            ...
            Column::make(__('Distance'), 'distance')->searchable(),
            // Column::make(__('Wallet Amount'), 'wallet_amount')->searchable(),
        ];
