...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            //generate tokens
            return $this->RegisterObject($user);
    ...
    public function authObject($user)
    {
        ...
        //     $walletTransaction->balance =  25.00;
    ...
    //when user register this function triggers
    public function RegisterObject($user)
    {
        ...
        return response()->json([
            ...
            "vehicle" => $vehicle,
            "vendor" => $vendor,
            "wallet"=>  $walletTransaction->user_id,
